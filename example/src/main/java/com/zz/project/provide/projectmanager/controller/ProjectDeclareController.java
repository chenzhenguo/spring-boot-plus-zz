...
public class ProjectDeclareController {
     ...
     */
    @PostMapping("/add")
    @Log(modelName = "申报管理表", action = Log.ADD,description="添加申报管理表")
    @ApiOperation(value = "添加申报管理表")
     ...
     */
    @PostMapping("/update")
   @Log(modelName = "修改申报管理表", action = Log.UPDATE,description="修改申报管理表")
    @ApiOperation(value = "修改申报管理表")
     ...
     */
    @PostMapping("delete")
   @Log(modelName = "删除申报管理表", action =Log.DELETE,description="删除申报管理表")
    @ApiOperation(value = "删除申报管理表")
    ...
    @Log(modelName = "批量删除申报管理表", action =Log.DELETE,description="批量删除除申报管理表")
    @ApiOperation(value = "批量删除申报管理表")
     ...
     */
    @PostMapping("getById")
   @Log(modelName = "申报管理表详情", action = Log.SELECT,description="根据id查询申报管理表")
    @ApiOperation(value = "申报管理表详情", response = ProjectDeclare.class)
    ...
    @PostMapping("/getPageList")
       @Log(modelName = "申报管理表分页列表", action = Log.SELECT,description="分页查询查询申报管理表")
    @ApiOperation(value = "申报管理表分页列表", response = ProjectDeclare.class)
