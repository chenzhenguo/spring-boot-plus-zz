...
@Api(value = "申报填报信息表API", tags = {"申报填报信息表"})
public class ProjectFillInController {
     ...
     */
    @PostMapping("/add")
    @Log(modelName = "申报填报信息表", action = Log.ADD,description="添加申报填报信息表")
    @ApiOperation(value = "添加申报填报信息表")
     ...
     */
    @PostMapping("/update")
   @Log(modelName = "修改申报填报信息表", action = Log.UPDATE,description="修改申报填报信息表")
    @ApiOperation(value = "修改申报填报信息表")
     ...
     */
    @PostMapping("delete")
   @Log(modelName = "删除申报填报信息表", action =Log.DELETE,description="删除申报填报信息表")
    @ApiOperation(value = "删除申报填报信息表")
    ...
    @Log(modelName = "批量删除申报填报信息表", action =Log.DELETE,description="批量删除除申报填报信息表")
    @ApiOperation(value = "批量删除申报填报信息表")
     ...
     */
    @PostMapping("getById")
   @Log(modelName = "申报填报信息表详情", action = Log.SELECT,description="根据id查询申报填报信息表")
    @ApiOperation(value = "申报填报信息表详情", response = ProjectFillIn.class)
    ...
    @PostMapping("/getPageList")
       @Log(modelName = "申报填报信息表分页列表", action = Log.SELECT,description="分页查询查询申报填报信息表")
    @ApiOperation(value = "申报填报信息表分页列表", response = ProjectFillIn.class)
