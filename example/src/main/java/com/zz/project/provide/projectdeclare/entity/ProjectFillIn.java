package com.zz.project.provide.projectdeclare.entity;
...
@TableName("zz_project_fill_in")
@ApiModel(value = "ProjectFillIn实体对象")
public class ProjectFillIn extends BaseEntity {
